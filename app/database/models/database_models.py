...
class UserAnalysisJob(Base):
    ...
    # 관계
    reports = relationship("UserReport", back_populates="job", cascade="all, delete-orphan")
    audio_files = relationship("UserAudioFile", back_populates="job", cascade="all, delete-orphan")
